...
const channels: Record<Channel, { label: string; icon: React.ReactNode; iconClass: string }> = {
...
export function ChannelBadge({ channel }: { channel: Channel }) {
    const { label, icon, iconClass } = channels[channel]
    return (
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-slate-200 bg-slate-50 text-slate-700">
