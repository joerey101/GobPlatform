        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-800 to-slate-950 flex items-center justify-center">
            <div className="w-full max-w-sm px-8 py-12 bg-white rounded-2xl shadow-2xl">
                ...
                <div className="space-y-3">
                    ...
                    <button
                        id="btn-login-backoffice"
                        className="w-full py-2.5 px-6 bg-slate-900 hover:bg-slate-800 text-white text-sm font-semibold
                       rounded-xl transition-all duration-200 focus:outline-none focus:ring-2
                       focus:ring-slate-700 focus:ring-offset-2 mt-2"
                    >
                        Ingresar al sistema
                    </button>
                </div>
